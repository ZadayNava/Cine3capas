    ...
    <div class="row">
        <asp:GridView ID="GVPeliculas" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Genero_Id" HeaderText="Genero" ItemStyle-Width="50px"/>
                <asp:BoundField DataField="Clasificacion_Id" HeaderText="Clasificacion" ItemStyle-Width="50px"/>
